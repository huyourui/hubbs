    ...
    <header class="admin-header">
        <div class="container">
            ...
            <nav class="admin-nav">
                ...
                <a href="<?php echo base_url('index.php?module=admin&action=update'); ?>" class="nav-link<?php echo $action === 'update' ? ' active' : ''; ?>">关于<?php echo isset($hasUpdate) && $hasUpdate ? ' <span class="update-dot">●</span>' : ''; ?></a>
            </nav>
